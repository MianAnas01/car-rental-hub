      ...
      <div className="bg-gray-300 p-8 rounded-lg shadow-lg max-w-4xl w-full flex flex-col md:flex-row items-center">
        <div className="flex-1">
          ...
          <form>
            ...
            <div className="mb-4">
              <input type="text" name="seats" placeholder="How many seats?" 
              // value={formData.seats} onChange={handleChange} 
              className="w-full p-2 border rounded-lg" />
            </div>
            <div className="mb-4">
              <input type="text" name="manual" placeholder="Manual/Auto" 
              // value={formData.manual} onChange={handleChange}
               className="w-full p-2 border rounded-lg" />
            </div>
            <div className="mb-4">
              <input type="text" name="rent" placeholder="Rent per day/per week in PKR" 
              // value={formData.rent} onChange={handleChange} 
              className="w-full p-2 border rounded-lg" />
            </div>
            <div className="mb-4">
              <input type="text" name="location" placeholder="Car location" 
              // value={formData.location} onChange={handleChange}
               className="w-full p-2 border rounded-lg" />
            </div>
            <div className="mb-4">
              <input type="text" name="License Plate" placeholder="License Plate Number" 
              // value={formData.location} onChange={handleChange}
               className="w-full p-2 border rounded-lg" />
            </div>
            <button type="button" 
      ...
      <div className="bg-gray-300 p-8 rounded-lg shadow-lg max-w-4xl w-full">
        ...
        <div className="flex items-center bg-red-500 text-white p-4 rounded-lg">
          ...
          <div className="text-right">
            ...
            <p>per day</p>
            <span className="bg-white text-red-500 px-2 py-1 rounded-full mt-2 inline-block">ACTIVE</span>
          </div>
        </div>
      </div>
    </div>
