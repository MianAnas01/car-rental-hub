...
//           if (vehicle._id === id) {
//             return { ...vehicle, status: "disable" }; // assuming 'status' is the field to be updated
//           }
//           return vehicle;
//         });
//         setVehicles(updatedVehicles);
...
//                       className="flex w-32 h-auto rounded-lg mr-4"
//                     />
//                       <p className="text-xl font-bold">{`${booking?.vehicleId?.carBrand} ${booking?.vehicleId?.carModel} ${booking?.vehicleId?.noOfSeats}  ${booking?.vehicleId?.address}  ${booking?.vehicleId?.licensePlate}  ${booking?.vehicleId?.transmission}`}</p>
//                     <div className="text-right">
//                       <p className="text-xl font-bold">{`Rs. ${booking?.vehicleId?.rentPerDay}`}</p>
//                       <p>per day</p>
