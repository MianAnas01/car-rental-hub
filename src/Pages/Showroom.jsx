      ...
      <div className="bg-gray-300 p-8 rounded-lg shadow-lg max-w-4xl w-full">
        ...
        {!loading ? (
          ...
          vehicles.map((item) => (
            <div
              key={item._id}
              className="flex items-center bg-red-500 text-white p-3 mb-4 rounded-lg"
            >
              <img
                src={item.avatar}
                alt="Car"
              ...
              />
              <div className="flex-1">
                <h3 className="text-xl font-bold">{item.carBrand} {item.carModel}</h3>
                <p>{item.noOfSeats} seaters • {item.transmission}</p>
              </div>
              <div className="text-right">
                <p className="text-xl font-bold">Rs. {item.rentPerDay}</p>
                <p>per day</p>
